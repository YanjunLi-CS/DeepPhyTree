...
def get_arguments():
    ...
    train.add_argument('--init_lr', '-l', type=float, default=0.003,
    ...
    train.add_argument('--lr_decay_step_or_patience', type=int, default=40,
                       help='learning rate decay patience on plateau')
    train.add_argument('--lr_decay_rate', '-a', type=float, default=0.2, help='The learning rate decay speed.')
    ...
    train.add_argument('--early_stopping', default=30, help='The early stopping step.')
