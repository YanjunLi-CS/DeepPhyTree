...
class AlyTSNE(object):
    def __init__(self, feat, label, subset, save_folder):
        self.feat = feat
        self.label = label
        self.subset = subset
    ...
    def plot(self, **kwargs):
        ...
        # plot_eps_fig = osp.join(tsne_plot_path, "{}.eps".format(self.subset))
        ...
        print(labels)
        leg = ax.legend(handles, labels, loc="upper right", ncol=1, borderaxespad=0., fontsize=25,
